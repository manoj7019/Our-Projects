...
document.getElementById('INUP').addEventListener('click', function() {
    ...
    document.getElementById('INHR').style.fill = 'rgba(0, 128, 0, 0.904)';
    document.getElementById('INAP').style.fill = 'rgba(0, 128, 0, 0.904)';
    document.getElementById('INCT').style.fill = 'rgba(0, 128, 0, 0.904)';
})
...
document.getElementById('INHR').addEventListener('click', function() {
    ...
    document.getElementById('INUP').style.fill = 'rgba(0, 128, 0, 0.904)';
    document.getElementById('INAP').style.fill = 'rgba(0, 128, 0, 0.904)';
    document.getElementById('INCT').style.fill = 'rgba(0, 128, 0, 0.904)';
})
